...
<template>
  ...
  >
    ...
    >
      ...
      >
        <p class="mb-4">
          Are you sure you want to flag this tool? This action cannot be undone and will remove this tool from future task batches.
        </p>
      ...
      >
        <div class="alert alert-success">
          ...
          <div>
            <h3 class="font-bold">
              Tool Flagged Successfully
            </h3>
            <div class="text-xs">
              Thank you for your feedback. The tool has been flagged and will be removed from future batches.
            </div>
          </div>
        </div>
        <button
